...
function CheckoutPage() {
  ...
  return (
    <div>
      <div className=' bg-[#E6614D] flex justify-between p-5'>
          <h2>Checkout</h2>
    ...
    <div className=' w-full h-auto flex justify-center'>
        ...
        <div className=' w-[50%] h-auto grid grid-cols-[auto_auto_auto] gap-4 pt-10 font-sans'>
          {cartItems.map((item) => (
            
              <div key={item._id} className='bg-[#FFFDD0] w-48 text-center h-64 pt-4 bg'>
